System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  function appInited(app) {
    ...
    var currentLevel = app.lib.storage.get(app.config.localkey.LEVEL_KEY);
    ...
    var runtime = globalThis; // TikTok Native Mini Games 官方命名空间为 TTMinis.game；
    // Cocos/字节兼容构建也可能暴露 tt。

    var isTikTokMiniGame = () => {
    ...
    var adConfig = isTikTokMiniGame() ? _crd && TIKTOK_AD_CONFIG === void 0 ? (_reportPossibleCrUseOfTIKTOK_AD_CONFIG({
      error: Error()
    ...
    (_crd && tiktokRequiredFeatures === void 0 ? (_reportPossibleCrUseOftiktokRequiredFeatures({
      ...
      onGrantReward: (type, amount) => {
        ...
        var rewardName = type === 'shortcut' ? 'Home Reward' : 'Revisit Reward';
