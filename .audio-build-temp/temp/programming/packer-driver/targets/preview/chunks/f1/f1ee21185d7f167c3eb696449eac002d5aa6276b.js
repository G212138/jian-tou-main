    ...
    execute: function () {
      ...
      PlatformService = class PlatformService {
        ...
        share(options) {
          ...
          var api = this.resolveApi('shareAppMessage');
        ...
        openMenuShare(options) {
          ...
          this.menuShareOptions = _extends({}, options);
          var api = this.resolveApi('onShareAppMessage');
          ...
          try {
            ...
            api.onShareAppMessage(() => _extends({}, this.menuShareOptions));
            api.onShareTimeline == null || api.onShareTimeline(() => _extends({}, this.menuShareOptions));
          } catch (error) {
            this.menuShareRegisteredOn = null;
        ...
        resolveApi(methodName) {
          ...
          var candidates = [(_this$runtime$TTMinis = this.runtime.TTMinis) == null ? void 0 : _this$runtime$TTMinis.game, this.runtime.tt, this.runtime.wx];
          return candidates.find(api => typeof (api == null ? void 0 : api[methodName]) === 'function') || null;
        }

        callVibration(methodName, options) {
          var api = this.resolveApi(methodName);
          if (!api) return;
