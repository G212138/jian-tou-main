    ...
    execute: function () {
      ...
      _export("TiliManager", TiliManager = (_dec = ccclass('TiliManager'), _dec(_class = class TiliManager extends (_crd && BaseManager === void 0 ? (_reportPossibleCrUseOfBaseManager({
        ...
        onLoad() {
          ...
          var currentHearts = (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            error: Error()
          ...
          var lastRecoveryTimestamp = (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            error: Error()
          }), app) : app).lib.storage.get((_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            error: Error()
        ...
        JianTingHeart() {
          var heart = (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            error: Error()
          }), app) : app).lib.storage.get((_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            error: Error()
          }), app) : app).config.localkey.TILI_KEY);
          ...
          if ((_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            ...
            var timeDiff = (Date.now() - (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
              error: Error()
            }), app) : app).store.game.getLastRecoveryTimestamp()) / 1000; //timeDiff 够几个 recoveryTime 就恢复多少体力

            var recoverCount = Math.floor(timeDiff / this.recoveryTime); // 恢复 recoverCount 点体力
            ...
            var timeDiffNext = timeDiff % this.recoveryTime;
            (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
              error: Error()
            ...
            var daoJiShi = this.parseTime(timeDiffNext);
            (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
              error: Error()
        ...
        parseTime(daoJiShi) {
          ...
          if (daoJiShi > -1) {
            // 格式化倒计时显示
            var minutes = Math.floor(daoJiShi / 60);
            var seconds = daoJiShi % 60; // 使用替代方法实现补零，避免padStart兼容性问题
