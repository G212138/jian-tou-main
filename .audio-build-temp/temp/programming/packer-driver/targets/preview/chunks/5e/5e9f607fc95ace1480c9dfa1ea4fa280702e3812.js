        ...
        */
        loadRecommend() {
          ...
          return _asyncToGenerator(function* () {
            ...
            _this.recommendPageManager = wx.createPageManager();
            yield _this.recommendPageManager.load({
        ...
        */
        ...
        showRecommend() {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (!_this2.recommendPageManager) {
              yield _this2.loadRecommend();
            }

            return yield _this2.recommendPageManager.show();
          })();
        }
        ...
        initCeilNodePool() {
          //箭头长度一般小于15
          for (var i = 0; i < 15; i++) {
            var newNode = instantiate(this.ceilPrefab); //敲碎道具用到
        ...
        getCeilNode() {
          ...
          var newNode = instantiate(this.ceilPrefab);
          newNode.addComponent(Label);
          return newNode;
        } // 将节点返回节点池
