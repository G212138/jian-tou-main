      ...
      _export("default", BaseManager = (_dec = ccclass('BaseManager'), _dec(_class2 = class BaseManager extends Component {
        ...
        constructor() {
          ...
          if (this._base_manager_name !== 'Manager' && this._base_manager_name.slice(-7) === 'Manager') {
            var managerName = this._base_manager_name.slice(0, -7);
        ...
        static init(bundle, progress, complete) {
          ...
          var userMgrList = []; // 系统manager(静态内置)

          var sysMgrList = [(_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
            error: Error()
          ...
          var initSysMgrTask = (_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
            error: Error()
          ...
          var loadUserMgrTask = (_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
            error: Error()
          }), Core) : Core).inst.lib.task.createASync();
          var UserManagerRoot = (_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
            error: Error()
          ...
          (_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
            ...
            // 初始化用户manager
            var initUserMgrTask = (_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
              error: Error()
            }), Core) : Core).inst.lib.task.createASync();
