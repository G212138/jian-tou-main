  ...
  function handleSet(obj, prop, receiver) {
    ...
    if (prop === 'add' || prop === 'delete' || prop === 'clear') {
      return function (val) {
        ...
        const result = Set.prototype[prop].call(obj, val); // 触发更新
  ...
  function create(target) {
    ...
    const proxy = new Proxy(target, {
      get(obj, prop, receiver) {
        ...
        const value = Reflect.get(obj, prop, receiver); // 如果值是函数，直接返回
      ...
      deleteProperty(obj, prop) {
        ...
        const result = Reflect.deleteProperty(obj, prop); // 触发更新
