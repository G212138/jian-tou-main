    ...
    execute: function () {
      ...
      _export("default", BaseView = (_dec = ccclass('BaseView'), _dec2 = disallowMultiple(), _dec3 = property({
        ...
        static BindController(Controller) {
          ...
          let BindController = (_dec8 = disallowMultiple(), _dec8(_class4 = class BindController extends BaseView {
            get controller() {
        ...
        onBaseViewCreate() {
          ...
          if (uiTransform) uiTransform.hitTest = (...args) => {
            if (this.blockInput) {
        ...
        createMixMiniViewsTask(views = [], data, onShow, onHide) {
          const task = (_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
            error: Error()
          }), Core) : Core).inst.lib.task.createSync();
          ...
          task.add(next => {
            const aSync = (_crd && Core === void 0 ? (_reportPossibleCrUseOfCore({
              error: Error()
