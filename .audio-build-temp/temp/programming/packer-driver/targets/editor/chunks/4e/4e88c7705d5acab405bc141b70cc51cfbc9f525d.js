System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, ProgressBar, LevelActionType, LevelResultType, app, adManager, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, NoTimeDialog;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "d322fHD9kVPXKR45+G/cgot", "NoTimeDialog", undefined);
      ...
      _export("NoTimeDialog", NoTimeDialog = (_dec = ccclass('NoTimeDialog'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(ProgressBar), _dec5 = property(Label), _dec(_class = (_class2 = class NoTimeDialog extends Component {
        constructor(...args) {
          super(...args);
        ...
        onLoad() {
          let remainCount = (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            error: Error()
          ...
          this.progressBar.progress = (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            ...
            error: Error()
          }), app) : app).manager.globaldata.ropeCount; // 报告失败事件
        ...
        onClickClose() {
          (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
            error: Error()
          }), app) : app).manager.event.emit("ShowRestartDialog", "NoTime");
        }
          ...
          (_crd && adManager === void 0 ? (_reportPossibleCrUseOfadManager({
            ...
            onClose: success => {
              if (!success) {
                (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
                  error: Error()
                }), app) : app).manager.ui.showToast("广告未播放完成");
                return;
              }
              ...
              (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
                ...
                levelResult: (_crd && LevelResultType === void 0 ? (_reportPossibleCrUseOfLevelResultType({
                  error: Error()
                }), LevelResultType) : LevelResultType).AD_REWARD,
                externInfo: {
                  failType: 'NoTime',
                  adProgress: 'Success'
                },
            ...
            onError: () => {
              (_crd && app === void 0 ? (_reportPossibleCrUseOfapp({
                error: Error()
              }), app) : app).manager.ui.showToast("广告播放失败");
            }
          });
        }
...
//# sourceMappingURL=4e88c7705d5acab405bc141b70cc51cfbc9f525d.js.map