...
// 预加载的UI列表
UIManager.setting.preload = ['PopResult','PageMain','PopSetting'];
// 默认UI, 会在首屏流程后自动show
...
// 预加载的音频(按数组顺序依次预加载)
SoundManager.setting.preload = ['music/bgm','effect/Button','effect/error',"effect/piano/A","effect/piano/B","effect/piano/C","effect/piano/D","effect/piano/E","effect/piano/F","effect/piano/G"];
// 默认音乐, 会在首屏流程后自动播放
