...
const messages: Record<string, Record<GameLanguage, string>> = {
    ...
    'level.select': { 'zh-CN': '选择关卡', 'en-US': 'Select Level' },
    'level.select_title': { 'zh-CN': '选择关卡（共 {count} 关）', 'en-US': 'Select Level ({count})' },
    'level.ad_badge': { 'zh-CN': '看广告', 'en-US': 'AD' },
    'level.unlock_ad_title': { 'zh-CN': '解锁第 {level} 关', 'en-US': 'Unlock Level {level}' },
    'level.unlock_ad_desc': { 'zh-CN': '完整观看一段广告即可永久解锁', 'en-US': 'Watch the full ad to unlock permanently' },
    'level.watch_ad': { 'zh-CN': '看广告解锁', 'en-US': 'Watch Ad' },
    'common.cancel': { 'zh-CN': '取消', 'en-US': 'Cancel' },
    'level.previous': { 'zh-CN': '上一页', 'en-US': 'Previous' },
    'level.next_page': { 'zh-CN': '下一页', 'en-US': 'Next' },
    'level.page': { 'zh-CN': '{page} / {total}', 'en-US': '{page} / {total}' },
    ...
    'tiktok.revisit_reward': { 'zh-CN': '侧边栏奖励', 'en-US': 'Sidebar Reward' },
    ...
    'tiktok.revisit_entry': { 'zh-CN': '侧边栏奖励  +2 体力', 'en-US': 'Sidebar Reward  +2 Energy' },
    'tiktok.home_unavailable': { 'zh-CN': '暂不支持添加桌面快捷方式', 'en-US': 'Home screen shortcut is unavailable' },
    'tiktok.revisit_unavailable': { 'zh-CN': '当前宿主暂不支持侧边栏复访', 'en-US': 'Sidebar revisit is unavailable in this host' },
    'tiktok.update_home': { 'zh-CN': '请更新 TikTok 后领取桌面奖励', 'en-US': 'Please update TikTok to use Home Reward' },
    'tiktok.update_revisit': { 'zh-CN': '请更新抖音后使用侧边栏奖励', 'en-US': 'Please update the app to use Sidebar Reward' },
    'tiktok.home_claimed': { 'zh-CN': '桌面奖励已领取', 'en-US': 'Home Reward already claimed' },
    'tiktok.revisit_claimed': { 'zh-CN': '今日侧边栏奖励已领取', 'en-US': 'Today’s Sidebar Reward has already been claimed' },
    'tiktok.home_started': { 'zh-CN': '已添加，请从桌面重新打开游戏领取 +3 体力', 'en-US': 'Added. Reopen from the Home Screen to claim +3 Energy' },
    'tiktok.revisit_started': { 'zh-CN': '请从抖音首页侧边栏重新进入游戏领取 +2 体力', 'en-US': 'Reopen the game from the sidebar to claim +2 Energy' },
    'tiktok.home_failed': { 'zh-CN': '桌面奖励失败，请重试', 'en-US': 'Home Reward failed. Please try again' },
    'tiktok.revisit_failed': { 'zh-CN': '侧边栏跳转失败，请重试', 'en-US': 'Sidebar navigation failed. Please try again' },
    'tiktok.delivery_failed': { 'zh-CN': '奖励发放失败，请重试', 'en-US': 'Reward delivery failed. Please try again' },
    'tiktok.sidebar_entry': { 'zh-CN': '侧边栏有奖', 'en-US': 'Sidebar Gift' },
    'tiktok.sidebar_entry_ready': { 'zh-CN': '立即领奖  +2 体力', 'en-US': 'Claim Now  +2 Energy' },
    'tiktok.sidebar_title': { 'zh-CN': '侧边栏进入领奖励', 'en-US': 'Enter Sidebar for Rewards' },
    'tiktok.sidebar_reward': { 'zh-CN': '每日奖励：+2 体力', 'en-US': 'Daily Reward: +2 Energy' },
    'tiktok.sidebar_step_title': { 'zh-CN': '完成步骤', 'en-US': 'How to complete' },
    'tiktok.sidebar_step_1': { 'zh-CN': '点击抖音首页侧边栏图标', 'en-US': 'Tap the Douyin sidebar icon' },
    'tiktok.sidebar_step_2': { 'zh-CN': '点击《难不到我吧》', 'en-US': 'Tap “Arrow Zen” in the sidebar' },
    'tiktok.sidebar_step_3': { 'zh-CN': '返回游戏，领取奖励', 'en-US': 'Return to the game and claim' },
    'tiktok.sidebar_daily': { 'zh-CN': '每日可完成并领取一次', 'en-US': 'Available once per day' },
    'tiktok.sidebar_go': { 'zh-CN': '去首页侧边栏', 'en-US': 'Go to Sidebar' },
    'tiktok.sidebar_claim': { 'zh-CN': '立即领奖', 'en-US': 'Claim Now' },
    'tiktok.sidebar_claimed': { 'zh-CN': '今日已领取', 'en-US': 'Claimed Today' },
};
...
const staticTranslations: Array<{ 'zh-CN': string; 'en-US': string }> = [
    ...
    { 'zh-CN': '侧边栏奖励  +2 体力', 'en-US': 'Sidebar Reward  +2 Energy' },
];
